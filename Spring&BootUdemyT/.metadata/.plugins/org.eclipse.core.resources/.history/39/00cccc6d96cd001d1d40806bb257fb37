...
//		m.addAttribute(emp);
	...
	@GetMapping("/getempf/{name}")
	private String findNameByQuerryAnnotation(@PathVariable String name) {
		System.out.println(employeeRepo.find(name));
		System.out.println("By Querry");
		return "result";
	}
